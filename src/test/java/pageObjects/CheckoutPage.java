...
public class CheckoutPage {
    ...
    private WebElement txtbx_CountryState;
    ...
    public void enter_CountryState(String country) {
    	txtbx_CountryState.sendKeys(country);
    }
    ...
    public void fill_PersonalDetails() {
        enter_Name("Name");
        enter_LastName("Surname");
        enter_Address("ul. Ulica");
        enter_City("Skopje");
        enter_CountryState("Macedonia");
        enter_PostCode("1000");
        enter_Phone("078542124154");
        enter_Email("test@gmail.com");
    }
}